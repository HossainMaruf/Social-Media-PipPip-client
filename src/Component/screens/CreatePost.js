...
const CreatePost = () =>{
    ...
    useEffect( ( )=>{
      ...
      if(url){
        fetch("https://fast-harbor-14116.herokuapp.com/createpost",{
           method:"post",
           headers:{
        ...
        .then(data =>{
            if(data.error){
                ...
                M.toast({html: 'created post successfully',classes:'#004d40 teal darken-4'});
                history.push('/')
            }
        })
        .catch(error =>{
    ...
    return (
        <div className="card input-field" style={{
            ...
            <textarea id="textarea1 multiliner" name="multiliner" class="materialize-textarea"
            placeholder="body"
            value={body}
